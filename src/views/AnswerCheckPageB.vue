        ...
        <div v-if="!gameCompleted">
          ...
          <div v-if="topPairData" class="answer-section">
            ...
            <div class="answer-pair clickable" @click="checkAnswer('top')" :class="{
              ...
              <div class="answer-box">
                <img :src="buildImg(sb[0].submsg, topPairData.part[sb[0].partName])"
                  :alt="`${sb[0].submsg}-${topPairData.part[sb[0].partName]}`" @error="onImgError" />
                <!-- <div class="caption">{{ sb[0].submsg }}</div> -->
              </div>
              <div class="answer-box">
                <img :src="buildImg(sb[1].submsg, topPairData.part[sb[1].partName])"
                  :alt="`${sb[1].submsg}-${topPairData.part[sb[1].partName]}`" @error="onImgError" />
          ...
          <div v-if="bottomPairData" class="answer-section">
            ...
            <div class="answer-pair clickable" @click="checkAnswer('bottom')" :class="{
              ...
              <div class="answer-box">
                <img :src="buildImg(sb[0].submsg, bottomPairData.part[sb[0].partName])"
                  :alt="`${sb[0].submsg}-${bottomPairData.part[sb[0].partName]}`" @error="onImgError" />
                <!-- <div class="caption">{{ sb[0].submsg }}</div> -->
              </div>
              <div class="answer-box">
                <img :src="buildImg(sb[1].submsg, bottomPairData.part[sb[1].partName])"
                  :alt="`${sb[1].submsg}-${bottomPairData.part[sb[1].partName]}`" @error="onImgError" />
                <!-- <div class="caption">{{ sb[1].submsg }}</div> -->
              </div>
            </div>
          </div>
